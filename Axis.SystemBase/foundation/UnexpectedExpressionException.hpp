#ifndef __UNEXPECTEDEXPRESSIONEXCEPTION_HPP
#define __UNEXPECTEDEXPRESSIONEXCEPTION_HPP
	...
	namespace axis
{
	...
	{
		/// <summary>
		/// Occurs when a certain expression is found to be misplaced in the
		/// input file.
		/// </summary>
		class AXISSYSTEMBASE_API UnexpectedExpressionException :
		...
		public:
			...
			/// </summary>	
			UnexpectedExpressionException(void);
			...
			UnexpectedExpressionException(const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			UnexpectedExpressionException(const String& filename, unsigned long lineNumber);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			UnexpectedExpressionException(const String& message, String& filename, unsigned long lineNumber, long column);
			...
			/// </remarks>
			UnexpectedExpressionException(const String& message);
			...
			/// </remarks>
			UnexpectedExpressionException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			UnexpectedExpressionException(const AxisException * innerException);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			UnexpectedExpressionException(const AxisException *innerException, const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			UnexpectedExpressionException(const AxisException *innerException, const String& filename, unsigned long lineNumber);

			UnexpectedExpressionException(const UnexpectedExpressionException& ex);

			UnexpectedExpressionException& operator =(const UnexpectedExpressionException& ex);
