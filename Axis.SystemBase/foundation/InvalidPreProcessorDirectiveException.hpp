...
namespace axis
{
	namespace foundation
	{
		...
		/// </summary>
		class AXISSYSTEMBASE_API InvalidPreProcessorDirectiveException :
		...
		public:
			...
			/// </summary>	
			InvalidPreProcessorDirectiveException(void);
			...
			InvalidPreProcessorDirectiveException(const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			InvalidPreProcessorDirectiveException(const String& filename, unsigned long lineNumber);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			InvalidPreProcessorDirectiveException(const String& message, String& filename, unsigned long lineNumber, long column);
			...
			/// </remarks>
			InvalidPreProcessorDirectiveException(const String& message);
			...
			/// </remarks>
			InvalidPreProcessorDirectiveException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			InvalidPreProcessorDirectiveException(const AxisException * innerException);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			InvalidPreProcessorDirectiveException(const AxisException *innerException, const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			InvalidPreProcessorDirectiveException(const AxisException *innerException, const String& filename, unsigned long lineNumber);

			InvalidPreProcessorDirectiveException(const InvalidPreProcessorDirectiveException& ex);

			InvalidPreProcessorDirectiveException& operator =(const InvalidPreProcessorDirectiveException& ex);
