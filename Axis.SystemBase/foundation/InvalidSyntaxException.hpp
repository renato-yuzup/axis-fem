#ifndef __INVALIDSYNTAXEXCEPTION_HPP
#define __INVALIDSYNTAXEXCEPTION_HPP
...
namespace axis
{
	...
	{
		/// <summary>
		/// Occurs when a parser component cannot interpret or expand part of the
		/// input stream to a valid expression, instruction or directive.
		/// </summary>
		class AXISSYSTEMBASE_API InvalidSyntaxException :
		...
		public:
			...
			InvalidSyntaxException(const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			InvalidSyntaxException(const String& filename, unsigned long lineNumber);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			InvalidSyntaxException(const String& message, String& filename, unsigned long lineNumber, long column);
			...
			/// </remarks>
			InvalidSyntaxException(const String& message);
			...
			/// </remarks>
			InvalidSyntaxException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			InvalidSyntaxException(const AxisException * innerException);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			InvalidSyntaxException(const AxisException *innerException, const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			InvalidSyntaxException(const AxisException *innerException, const String& filename, unsigned long lineNumber);

			InvalidSyntaxException(const InvalidSyntaxException& ex);

			InvalidSyntaxException& operator =(const InvalidSyntaxException& ex);
