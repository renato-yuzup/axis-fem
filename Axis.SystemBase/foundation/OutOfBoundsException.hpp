/// <summary>
/// Contains definition for the class axis::foundation::OutOfBoundsException.
/// </summary>
...
namespace axis	
{
	...
	{
		class AXISSYSTEMBASE_API OutOfBoundsException :
		...
		public:
			...
			/// </remarks>
			OutOfBoundsException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			OutOfBoundsException(const AxisException * innerException);
