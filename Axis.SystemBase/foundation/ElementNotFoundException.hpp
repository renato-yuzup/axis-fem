...
namespace axis
{
	namespace foundation
	{
		...
		/// </summary>
		class AXISSYSTEMBASE_API ElementNotFoundException :
		...
		public:
			...
			/// </remarks>
			ElementNotFoundException(const String& message);
			...
			/// </remarks>
			ElementNotFoundException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			ElementNotFoundException(const AxisException * innerException);

			ElementNotFoundException(const ElementNotFoundException& ex);

			ElementNotFoundException& operator =(const ElementNotFoundException& ex);
