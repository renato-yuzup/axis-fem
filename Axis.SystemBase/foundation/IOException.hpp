...
namespace axis
{
	namespace foundation
	{
		...
		/// </summary>
		class AXISSYSTEMBASE_API IOException : public AxisException
		{
		public:
			/// <summary>
			...
			/// </remarks>
			IOException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			IOException(const AxisException * innerException);
