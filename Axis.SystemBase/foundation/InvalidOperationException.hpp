...
namespace axis
{
	namespace foundation
	{
		...
		/// </summary>
		class AXISSYSTEMBASE_API InvalidOperationException :
		...
		public:
			...
			/// </remarks>
			InvalidOperationException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			InvalidOperationException(const AxisException * innerException);

			InvalidOperationException(const InvalidOperationException& ex);
