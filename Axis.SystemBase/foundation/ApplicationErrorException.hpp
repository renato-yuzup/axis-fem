/// <summary>
/// Contains definitions for the class axis::foundation::ApplicationErrorException.
/// </summary>
...
namespace axis	
{
	...
	{
		/// <summary>
		/// Occurs when an error caused by external means is raised.
		/// <summary>
		class AXISSYSTEMBASE_API ApplicationErrorException : public AxisException
		{
		public:
			/// <summary>
			/// Creates a new exception with no description message.
			/// </summary>	
			ApplicationErrorException(void);
			...
			/// </remarks>
			ApplicationErrorException(const String& message);
			...
			/// </remarks>
			ApplicationErrorException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			ApplicationErrorException(const AxisException * innerException);

			ApplicationErrorException(const ApplicationErrorException& ex);

			ApplicationErrorException& operator =(const ApplicationErrorException& ex);
