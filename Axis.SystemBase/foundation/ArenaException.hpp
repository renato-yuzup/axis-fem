...
namespace axis
{
	...
	{
		class AXISSYSTEMBASE_API ArenaException : public ApplicationErrorException
		{
		public:
			/// <summary>
			...
			/// </remarks>
			ArenaException(const String& message);
			...
			/// </remarks>
			ArenaException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			ArenaException(const AxisException * innerException);

			ArenaException(const ArenaException& ex);

			ArenaException& operator =(const ArenaException& ex);
