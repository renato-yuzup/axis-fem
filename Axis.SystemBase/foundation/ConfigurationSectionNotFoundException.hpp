/// <summary>
/// Contains definitions for the class axis::foundation::ConfigurationSectionNotFoundException.
/// </summary>
...
namespace axis
{
	namespace foundation
	{
		...
		/// </summary>
		class AXISSYSTEMBASE_API ConfigurationSectionNotFoundException :
		...
		public:
			...
			/// </summary>	
			ConfigurationSectionNotFoundException(void);

			/// <summary>
			/// Creates a new exception pointing to where the configuration was not found.
			/// </summary>	
			ConfigurationSectionNotFoundException(String &location);

			/// <summary>
			/// Creates a new exception pointing to where the configuration was not found.
			/// </summary>	
			ConfigurationSectionNotFoundException(const char_type *location);
			...
			/// </remarks>
			ConfigurationSectionNotFoundException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			ConfigurationSectionNotFoundException(const AxisException * innerException);
			...
			ConfigurationSectionNotFoundException(const ConfigurationSectionNotFoundException& ex);

			ConfigurationSectionNotFoundException& operator =(const ConfigurationSectionNotFoundException& ex);
