/// <summary>
/// Contains definitions for the class axis::foundation::OverflowException.
/// </summary>
...
namespace axis
{
	namespace foundation
	{
		...
		/// </summary>	
		class AXISSYSTEMBASE_API OverflowException : public AxisException
		{
		public:
			/// <summary>
			...
			/// </remarks>
			OverflowException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			OverflowException(const AxisException * innerException);

			OverflowException(const OverflowException& ex);
