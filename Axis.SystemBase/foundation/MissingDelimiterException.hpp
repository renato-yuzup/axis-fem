#ifndef __MISSINGDELIMITEREXCEPTION_HPP
#define __MISSINGDELIMITEREXCEPTION_HPP
...
namespace axis
{
	namespace foundation
	{
		...
		/// </summary>
		class AXISSYSTEMBASE_API MissingDelimiterException :
		...
		public:
			...
			/// </summary>	
			MissingDelimiterException(void);
			...
			MissingDelimiterException(const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			MissingDelimiterException(const String& filename, unsigned long lineNumber);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			MissingDelimiterException(const String& message, String& filename, unsigned long lineNumber, long column);
			...
			/// </remarks>
			MissingDelimiterException(const String& message);
			...
			/// </remarks>
			MissingDelimiterException(const String& message, const AxisException * innerException);
			...
			/// </remarks>
			MissingDelimiterException(const AxisException * innerException);
			...
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			/// <param name="column">The column index on which the error occurred. A non-positive number indicates an undefined column.</param>
			MissingDelimiterException(const AxisException *innerException, const String& filename, unsigned long lineNumber, long column);
			...
			/// <param name="filename">The file (or stream description) on which the error occurred.</param>
			/// <param name="lineNumber">The line index on which the error occurred.</param>
			MissingDelimiterException(const AxisException *innerException, const String& filename, unsigned long lineNumber);

			MissingDelimiterException(const MissingDelimiterException& ex);

			MissingDelimiterException operator =(const MissingDelimiterException& ex);
