...
class MappedSet<Key, Value>::Pimpl
{
public:
  struct mutable_pair
  {
  ...
  typedef boost::multi_index::hashed_unique<boost::multi_index::member<mutable_pair,KeyType,&mutable_pair::first>, hash_string<wchar_t>, string_equal_to<wchar_t>> unique_index;
