 ...
 */
class AXISCOMMONLIBRARY_API ElementStrainCollector : public ElementSetCollector
{
public:
  /**
   ...
   */
  static ElementStrainCollector& Create(const axis::String& targetSetName);
  ...
  virtual ~ElementStrainCollector(void);
...
private:
  ElementStrainCollector(const axis::String& targetSetName, const axis::String& customFieldName);
  ElementStrainCollector(const axis::String& targetSetName, const axis::String& customFieldName,
