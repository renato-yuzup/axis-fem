...
**/
class AXISCOMMONLIBRARY_API SummaryElementPlasticStrainCollector : public SummaryElement6DCollector
{
public:
  static SummaryElementPlasticStrainCollector& Create(const axis::String& targetSetName, SummaryType summaryType);
  static SummaryElementPlasticStrainCollector& Create(const axis::String& targetSetName, SummaryType summaryType,
  ...
  virtual ~SummaryElementPlasticStrainCollector(void);
  virtual void Destroy( void ) const;
private:
  SummaryElementPlasticStrainCollector(const axis::String& targetSetName, SummaryType summaryType);
  SummaryElementPlasticStrainCollector(const axis::String& targetSetName, SummaryType summaryType,
                                axis::application::output::collectors::XXDirectionState xxState,
                                axis::application::output::collectors::YYDirectionState yyState,
                                axis::application::output::collectors::ZZDirectionState zzState,
