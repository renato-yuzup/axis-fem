 ...
 * @sa NodeSetCollector
 */
class AXISCOMMONLIBRARY_API NodeDisplacementCollector : public NodeSetCollector
{
public:
  /**
   ...
   */
  static NodeDisplacementCollector& Create(const axis::String& targetSetName);
  ...
  virtual ~NodeDisplacementCollector(void);
...
private:
  NodeDisplacementCollector(const axis::String& targetSetName, const axis::String& customFieldName);
  NodeDisplacementCollector(const axis::String& targetSetName, const axis::String& customFieldName,
