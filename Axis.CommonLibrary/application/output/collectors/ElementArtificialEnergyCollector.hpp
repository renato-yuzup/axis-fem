 ...
 */
class AXISCOMMONLIBRARY_API ElementArtificialEnergyCollector : public ElementSetCollector
{
public:
  /**
   ...
   */
  static ElementArtificialEnergyCollector& Create(const axis::String& targetSetName);
  ...
  virtual ~ElementArtificialEnergyCollector(void);
...
private:
  ElementArtificialEnergyCollector(const axis::String& targetSetName, const axis::String& customFieldName);
