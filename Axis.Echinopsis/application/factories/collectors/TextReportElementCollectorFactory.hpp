...
class TextReportElementCollectorFactory : public CollectorFactory
{
public:
  ...
  TextReportElementCollectorFactory(void);
  virtual ~TextReportElementCollectorFactory(void);
...
private:
  ...
  TextReportElementCollectorFactory(const TextReportElementCollectorFactory&);
  TextReportElementCollectorFactory& operator = (const TextReportElementCollectorFactory&);
