...
namespace axis { namespace application { namespace output { namespace collectors {
  ...
  class TextReportNode6DCollector : public GenericCollector
  {
  private:
    bool dofsToPrint_[6];
    axis::String targetSetName_;
  public:
    TextReportNode6DCollector(const axis::String& targetSetName, const bool *activeDirections);
    virtual ~TextReportNode6DCollector(void);
