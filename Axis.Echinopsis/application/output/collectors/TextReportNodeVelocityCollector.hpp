...
namespace axis { namespace application { namespace output { namespace collectors {
  ...
  class TextReportNodeVelocityCollector : public TextReportNode3DCollector
  {
  public:
    TextReportNodeVelocityCollector(const axis::String& targetSetName, const bool *activeDirections);
    ~TextReportNodeVelocityCollector(void);
