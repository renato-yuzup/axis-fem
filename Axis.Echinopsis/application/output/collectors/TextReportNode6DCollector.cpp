...
aaoc::TextReportNode6DCollector::TextReportNode6DCollector( const axis::String& targetSetName, 
...
aaoc::TextReportNode6DCollector::~TextReportNode6DCollector( void )
{
  // nothing to do here
}

void aaoc::TextReportNode6DCollector::Collect( const asmm::ResultMessage& message, 
...
bool aaoc::TextReportNode6DCollector::IsOfInterest( const asmm::ResultMessage& message ) const
{
  return adam::ModelStateUpdateMessage::IsOfKind(message);
}

axis::String aaoc::TextReportNode6DCollector::GetFriendlyDescription( void ) const
{
  String desc;
  int dirCount = 0;
  for (unsigned int i = 0; i < 6; ++i)
...
void aaoc::TextReportNode6DCollector::PrintHeader( aaor::ResultRecordset& recordset )
{
  aaor::TextReportRecordset& r = static_cast<aaor::TextReportRecordset&>(recordset);
...
axis::String aaoc::TextReportNode6DCollector::BuildColumnHeader( void )
{
