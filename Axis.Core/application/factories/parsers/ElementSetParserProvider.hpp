...
class ElementSetParserProvider: public axis::application::factories::parsers::BlockProvider
{
public:
	ElementSetParserProvider(void);
	virtual ~ElementSetParserProvider(void);
