/**********************************************************************************************//**
 * @file	foundation/blas/ColumnVector.hpp
 *
...
/**********************************************************************************************//**
	...
	* @sa	Vector
	**************************************************************************************************/
class AXISBLAS_API ColumnVector 
{
public:
	...
	/**********************************************************************************************//**
		...
		**************************************************************************************************/
	explicit ColumnVector(size_type length);
	...
	/**********************************************************************************************//**
		...
		**************************************************************************************************/
	ColumnVector(size_type length, real initialValue);
	...
	/**********************************************************************************************//**
		...
		**************************************************************************************************/
	ColumnVector(size_type length, const real * const values);
	...
	/**********************************************************************************************//**
		...
		**************************************************************************************************/
	ColumnVector(size_type length, const real * const values, size_type elementCount);
...
private:
  ...
  ColumnVector(const self& other, const MemorySource& memorySource);
	ColumnVector(size_type length, const MemorySource& memorySource);
	ColumnVector(size_type length, real initialValue, const MemorySource& memorySource);
	ColumnVector(size_type length, const real * const values, const MemorySource& memorySource);
	ColumnVector(size_type length, const real * const values, size_type elementCount, const MemorySource& memorySource);
...
typedef ColumnVector FirstTensor;
