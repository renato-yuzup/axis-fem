...
bool MatrixIsProductCompatible(const Matrix& m1, const Matrix& m2, bool m1Transposed = false, bool m2Transposed = false)
{
  size_type c1, r2;
...
bool MatrixIsProductCompatible(const T1& m1, const T2& m2, bool m1Transposed = false, bool m2Transposed = false)
{
  size_type c1, r2;
  c1 = m1Transposed? m1.Rows() : m1.Columns();
  r2 = m2Transposed? m2.Columns() : m2.Rows();
...
/**********************************************************************************************//**
	...
	**************************************************************************************************/
template <class Matrix>
bool MatrixIsResultCompatible(const Matrix& m, size_type rows, size_type columns, bool storeTransposed = false)
{
