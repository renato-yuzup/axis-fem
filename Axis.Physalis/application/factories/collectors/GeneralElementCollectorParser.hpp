...
class GeneralElementCollectorParser
{
public:
  GeneralElementCollectorParser(void);
  ~GeneralElementCollectorParser(void);
...
private:
  ...
  CollectorParseResult InterpretScalarParseTree(
    const axis::services::language::parsing::ParseResult& result) const;
  ...
  axis::services::language::primitives::GeneralExpressionParser reactionForceName_;
  ...
  axis::services::language::primitives::GeneralExpressionParser scalarCollectorStatement_;
  axis::services::language::primitives::OrExpressionParser scalarGroupingType_;
  axis::services::language::primitives::OrExpressionParser scalarCollectorType_;
};
