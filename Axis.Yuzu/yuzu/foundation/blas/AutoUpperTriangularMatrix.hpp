/**********************************************************************************************//**
 * @file	foundation/blas/AutoUpperTriangularMatrix.hpp
 *
...
/**********************************************************************************************//**
	...
	**************************************************************************************************/
template <int N>
class AutoUpperTriangularMatrix
{
public:
	...
	/**********************************************************************************************//**
		...
		**************************************************************************************************/
	typedef AutoUpperTriangularMatrix<N> self;
	...
	/**********************************************************************************************//**
		...
		* @date	19 ago 2012
		**************************************************************************************************/
	GPU_ONLY AutoUpperTriangularMatrix(void)
  {
    // nothing to do here
  }
	...
	/**********************************************************************************************//**
		...
		**************************************************************************************************/
	GPU_ONLY AutoUpperTriangularMatrix(const self& other)
  {
    CopyFrom(other);
  }
	...
	/**********************************************************************************************//**
		...
		**************************************************************************************************/
  explicit GPU_ONLY AutoUpperTriangularMatrix(real value)
  {
    SetAll(value);
  }

  explicit GPU_ONLY AutoUpperTriangularMatrix(const real * const values)
  {
    CopyFromVector(values, N*(N+1)/2);
  }

  GPU_ONLY AutoUpperTriangularMatrix(const real * const values, size_type count)
  {
  ...
  {
    return (row <= column)? data_[column * (column+1) / 2 + row] : 0;
  }
  ...
  {
    data_[column * (column+1) / 2 + row] = value;
  }
